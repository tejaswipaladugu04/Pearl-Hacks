This project is called Mental Metric. This project calculates how the user feels in a day and generates a set of recommendations based on the algorithm's understanding of the user mood. 
